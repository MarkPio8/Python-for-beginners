...
print('low median =',statistics.median_low(percent))
print('high median =',statistics.median_high(percent))

from statistics import *
print('median =',median(percent))
print('low median =',median_low(percent))
print('high median =',median_high(percent))
